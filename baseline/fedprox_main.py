...
from fedprox_server.fedprox_update import LocalUpdate, test_inference
from fedprox_server.fedprox_nlp_update import nlpLocalUpdate, nlp_test_inference
...
if __name__ == '__main__':
    ...
    if not os.path.exists('fedprox_acc_record_{}'.format(args.dataset)):
        os.mkdir('fedprox_acc_record_{}'.format(args.dataset))
    filename = 'fedprox_acc_record_{}/fedprox_noise_{}_lowerb_{}_frac_{}_user_{}.txt'.format(args.dataset, args.level_n_system, args.level_n_lowerb, args.frac, args.num_users)
    with open(filename,'w') as f:
        f.write('Here is the record of the training of fedprox!\n')
